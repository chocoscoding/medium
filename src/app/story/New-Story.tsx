...
const NewStory = ({ storyId, Storycontent }: Props) => {
  ...
  const handleSave = async () => {
    ...
    setSaving(true);
    const StoryData = new StoryDataExtractor(contentEditabeRef.current?.innerHTML as string);
    const storyTitle = StoryData.extractH1Content();
